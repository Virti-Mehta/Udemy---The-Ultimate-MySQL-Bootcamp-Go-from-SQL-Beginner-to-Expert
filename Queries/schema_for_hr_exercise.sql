...
--
CREATE DATABASE wpracti_bookinfo;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `job_history` (
  ...
  FOREIGN KEY `JHIST_DEPARTMENT_IX` (`DEPARTMENT_ID`) REFERENCES departments(`DEPARTMENT_ID`),
  KEY `JHIST_EMPLOYEE_IX` (`EMPLOYEE_ID`),
  FOREIGN KEY `JHIST_JOB_IX` (`JOB_ID`) REFERENCES jobs(`JOB_ID`)
) ;
